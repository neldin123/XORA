    ...
    <section>
      <Element name="features">
        <div className="container">
          <div
            className={
              "relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3"
            }
          >
            ...
            <ul className="relative flex justify-around grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden ">
              <div className="absolute bg-s3/20 top-[41%] left-0 right-0 w-full h-px z-10" />
